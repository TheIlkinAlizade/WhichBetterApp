    ...
    return (
        ...
        <div className="content">
            <div className="sidebar">
                <h1 className="sidetext">Which is handsomer?</h1>
                <h1 className="sidetext">Which is hotter?</h1>
                <h1 className="sidetext">Which is better?</h1>
                <h1 className="sidetext">Which is legendary?</h1>
                <h1 className="sidetext">Which is Masterpiece?</h1>
            </div>
